...
function toolDefinitions() {
  const tools = [
    ...
    },
    {
      ...
      description: 'Open a URL, search query, absolute local file, or workspace-relative preview in the persistent Agent-owned Yan browser tab. Sequential Yan tasks reuse an idle Agent tab and its current page; this never replaces a normal user-created tab. Use it first for ordinary browsing, research, local previews, and website verification.',
      inputSchema: {
        type: 'object',
        properties: {
