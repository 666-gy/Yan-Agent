...
**Note:** Scripts may be executed without loading into context, but can still be read by Yan Agent for patching or environment adjustments.

### references/
Documentation and reference material intended to be loaded into context to inform Yan Agent's process and thinking.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information that Yan Agent should reference while working.
